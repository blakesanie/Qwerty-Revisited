...
function printKeys() {
    console.log("\n" + topRow[0] + topRow[1] + topRow[2] + topRow[3] + topRow[4] + topRow[5] + topRow[6] + topRow[7] + topRow[8] + topRow[9] + "\n" + middleRow[0] + middleRow[1] + middleRow[2] + middleRow[3] + middleRow[4] + middleRow[5] + middleRow[6] + middleRow[7] + middleRow[8] + "\n " + bottomRow[0] + bottomRow[1] + bottomRow[2] + bottomRow[3] + bottomRow[4] + bottomRow[5] + bottomRow[6]);
}
